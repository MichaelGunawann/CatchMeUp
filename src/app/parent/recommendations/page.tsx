...
/**
 * Thin real-route wrapper around the existing ParentRecommendations screen
 * in product-app.tsx - same auth guard pattern as
 * src/app/parent/dashboard/page.tsx. Note: this screen's data
 * (teachingRecommendations) is still an empty mock array - wrapping it only
...
export default function ParentRecommendationsPage() {
  ...
  return <ProductApp path={["parent", "recommendations"]} />;
}
