...
/**
 * Thin real-route wrapper around the existing AdminStudents screen in
 * product-app.tsx - same auth guard pattern as
 * src/app/admin/dashboard/page.tsx. Note: this screen's data
 * (mockStudentList) is still inline hardcoded mock - wrapping it only
...
export default function AdminStudentsPage() {
  ...
  return <ProductApp path={["admin", "students"]} />;
}
