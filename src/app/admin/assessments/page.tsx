...
/**
 * Thin real-route wrapper around the existing AdminAssessments screen in
 * product-app.tsx - same auth guard pattern as
 * src/app/admin/dashboard/page.tsx. Note: this screen's data
 * (platformAssessments) is still inline hardcoded mock - wrapping it only
...
export default function AdminAssessmentsPage() {
  ...
  return <ProductApp path={["admin", "assessments"]} />;
}
